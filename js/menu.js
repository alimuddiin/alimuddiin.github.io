(function(Phaser){
  ...
  menuState.prototype = {
    ...
    initTitle: function(){
      ...
      if(this.game.device.desktop){
        ...
        var muteLabel = this.game.add.text(150, this.game.world.height - 10,
          ' tekan tombol M pada keyboard untuk mengatur suara game selingkuh',
    ...
    initScore: function(){
      ...
      var startText;
      if(this.game.device.desktop){
        startText = 'arah atas > untuk mulai selingkuh';
      }
      else{
        startText = 'Sentuh layar untuk mulai selingkuh lagi';
      }

      var scoreLabel= this.game.add.text(this.game.world.centerX, this.game.world.centerY,
        'Nilai: ' + this.game.global.score +
        '\nHasil terbaik perselingkuhan: ' + this.bestScoreValue,
        { font: '10px Arial', fill: '#fff', align: 'center' });
    ...
    initBestScore: function(){
      ...
      var bestScore = storagePrefix + 'Hasil terbaik perselingkuhan';
